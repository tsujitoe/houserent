...
class Suites(models.Model):
	...
	suite_how_inter_housedoor=models.CharField(verbose_name='如何進入案件', default='公司Key|密碼|屋主開門', max_length=50)
	...
	suite_drink=models.CharField(verbose_name='飲水', default='自理|無', max_length=20)
